...
namespace Examples {
  ...
  public:
    Frame() : wxFrame(nullptr, wxID_ANY, "MultiChoiceDialog example", wxDefaultPosition, {300, 300}) {
      button->Bind(wxEVT_BUTTON, [&](wxCommandEvent& event) {
        label->SetLabel("");
        std::vector<wxString> choices = {"item 1", "item 2", "item 3", "item 4", "item 5", "item 6", "item 7", "item 8", "item 9", "item 10"};
        wxMultiChoiceDialog dialog(this, "Message text", "Caption text", choices.size(), choices.data());
