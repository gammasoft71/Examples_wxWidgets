...
private:
  wxPanel panel {this};
  wxGauge progressBar1 {&this->panel, wxID_ANY, 100, wxPoint(50, 50), wxSize(200, 25)};
  wxGauge progressBar2 {&this->panel, wxID_ANY, 100, wxPoint(50, 80), wxSize(200, 25)};
  wxGauge progressBar3 {&this->panel, wxID_ANY, 100, wxPoint(50, 110), wxSize(200, 25)};
  wxGauge progressBar4 {&this->panel, wxID_ANY, 100, wxPoint(50, 140), wxSize(200, 25)};
  wxGauge progressBar5 {&this->panel, wxID_ANY, 100, wxPoint(50, 170), wxSize(200, 25)};
  wxTimer timer;
};
