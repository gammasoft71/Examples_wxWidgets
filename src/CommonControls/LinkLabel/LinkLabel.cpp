...
private:
  ...
  wxHyperlinkCtrl* label3 = new wxHyperlinkCtrl(this->panel, wxID_ANY, "wxWidgets", "https://gammasoft71.wixsite.com/gammasoft/wxwidgets", wxPoint(label2->GetPosition().x + this->label2->GetSize().GetWidth(), 10));
