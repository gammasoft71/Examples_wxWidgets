  ...
  public:
    Form() : wxFrame(nullptr, wxID_ANY, "Paint example", wxDefaultPosition, wxSize(300, 300)) {
      ...
      Bind(wxEVT_PAINT, [&](wxPaintEvent& event) {
        ...
        DrawLString(dc, "Draw string", wxFont(points_to_native_font_graphics_untit(34), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, "Arial"), wxBrush(wxColour(0x90, 0xEE, 0x90)), 20, 0);
