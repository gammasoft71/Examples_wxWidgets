...
namespace Examples {
  ...
  private:
    ...
    wxTextCtrl* textCtrl1 = new wxTextCtrl(panel, wxID_ANY, "textBox", {10, 10}, {280, 130}, wxTE_MULTILINE);
    wxTextCtrl* textCtrl2 = new wxTextCtrl(panel, wxID_ANY, "textBox", {10, 150}, {280, 130}, wxTE_MULTILINE);
  };
