...
namespace Examples {
  ...
  private:
    ...
    wxPanel* panel1 = new wxPanel(panelMain, wxID_ANY, wxDefaultPosition, {400, 100}, wxTAB_TRAVERSAL|wxBORDER_SIMPLE);
    wxPanel* panel2 = new wxPanel(panelMain, wxID_ANY, wxDefaultPosition, {400, 100}, wxTAB_TRAVERSAL|wxBORDER_SIMPLE);
    wxPanel* panel3 = new wxPanel(panelMain, wxID_ANY, wxDefaultPosition, {400, 100}, wxTAB_TRAVERSAL|wxBORDER_SIMPLE);
    wxPanel* panel4 = new wxPanel(panelMain, wxID_ANY, wxDefaultPosition, {400, 100}, wxTAB_TRAVERSAL|wxBORDER_SIMPLE);
    wxPanel* panel5 = new wxPanel(panelMain, wxID_ANY, wxDefaultPosition, {400, 100}, wxTAB_TRAVERSAL|wxBORDER_SIMPLE);
  };
