...
public:
  Form() : wxFrame(nullptr, wxID_ANY, "Cursor example", wxDefaultPosition) {
    ...
    this->testZone->SetBackgroundColour(wxSystemSettings::GetColour(wxSystemColour::wxSYS_COLOUR_WINDOW));
  }
...
private:
  ...
  wxPanel* testZone = new wxPanel(this->panel, wxID_ANY, wxPoint(190, 20), wxSize(150, 200), wxBORDER_SUNKEN);
};
