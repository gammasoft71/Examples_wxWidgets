...
public:
  Frame() : wxFrame(nullptr, wxID_ANY, "DateTimePicker example", wxDefaultPosition, wxSize(300, 300)) {
...
private:
  ...
  wxStaticText* staticText1 = new wxStaticText(panel, wxID_ANY, wxEmptyString, wxPoint(30, 60));
};
